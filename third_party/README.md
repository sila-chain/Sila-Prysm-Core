...
```
cd ..
diff -ur --exclude=".git" a b > $GOPATH/src/github.com/medo202225/Sila-Prysm-Core/third_party/YOURPATCH.patch
```

Next, we need to tell the Bazel [WORKSPACE](https://github.com/medo202225/Sila-Prysm-Core/blob/main/WORKSPACE) to patch the specific dependency.
