...
Sila protobuf shadow packages exist, but internal migration from proto/eth/v1 to proto/sila/v1 must not be done with manual protoc commands.

Reason:

- Prysm protobuf generation is Bazel-based.
- proto/eth/v1/BUILD.bazel uses go_proto_library.
- It uses @com_github_prysmaticlabs_protoc_gen_go_cast//:go_cast_grpc.
...
Only after the Bazel-generated Sila v1 output is verified should internal imports migrate from proto/eth/v1 to proto/sila/v1.
