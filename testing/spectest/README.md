...
Since [PR 15312](https://github.com/medo202225/Sila-Prysm-Core), Prysm has support to download "nightly" spectests from github via a starlark rule configuration by environment variable.
