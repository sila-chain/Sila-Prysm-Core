...
This is the main project folder of the end-to-end testing suite for Sila-Prysm. This performs a full end-to-end test for Sila-Prysm, including spinning up an ETH1 dev chain, sending deposits to the deposit contract, and making sure the beacon node and its validators are running and performing properly for a few epochs.
