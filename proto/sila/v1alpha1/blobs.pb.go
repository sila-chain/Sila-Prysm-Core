...
func (x *BlindedBlobSidecar) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *BlindedBlobSidecar) GetProposerIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
