...
func (x *BeaconBlockHeader) GetProposerIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *VoluntaryExit) GetValidatorIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *Fork) GetEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
		return x.Epoch
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch(0)
...
type Validator struct {
	...
	WithdrawableEpoch          github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch `protobuf:"varint,8,opt,name=withdrawable_epoch,json=withdrawableEpoch,proto3" json:"withdrawable_epoch,omitempty" cast-type:"github.com/sila-chain/Sila-Consensus-Core/v7/consensus-types/primitives.Epoch"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *Validator) GetActivationEligibilityEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *Validator) GetActivationEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *Validator) GetExitEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
		return x.ExitEpoch
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch(0)
...
func (x *Validator) GetWithdrawableEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
