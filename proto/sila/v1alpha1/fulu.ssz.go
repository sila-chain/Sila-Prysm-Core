...
func (b *BeaconStateFulu) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 64; ii++ {
		b.ProposerLookahead[ii] = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[2736713:2737225][ii*8 : (ii+1)*8])
	}
...
func (s *StatusV2) UnmarshalSSZ(buf []byte) error {
	...
	// Field (5) 'EarliestAvailableSlot'
	s.EarliestAvailableSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[84:92])
