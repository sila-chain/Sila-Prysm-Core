...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[0:8])
...
func (d *DataColumnSidecarsByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	d.StartSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[0:8])
...
func (e *SilaPayloadEnvelopesByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	e.StartSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[0:8])
