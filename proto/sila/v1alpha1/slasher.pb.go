...
func (x *HighestAttestation) GetHighestSourceEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *HighestAttestation) GetHighestTargetEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
