...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[0:8])
...
func (l *LightClientUpdateAltair) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[25360:25368])
...
func (l *LightClientFinalityUpdateAltair) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[576:584])
...
func (l *LightClientOptimisticUpdateAltair) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[272:280])
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[40:48])
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[0:8])
