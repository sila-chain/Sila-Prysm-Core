...
func (x *SyncCommitteeMessage) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *SyncCommitteeMessage) GetValidatorIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *ContributionAndProof) GetAggregatorIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *SyncCommitteeContribution) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot(0)
