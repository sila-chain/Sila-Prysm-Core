...
func (x *AggregateAttestationAndProof) GetAggregatorIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *AttestationData) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *AttestationData) GetCommitteeIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.CommitteeIndex {
	if x != nil {
...
func (x *Checkpoint) GetEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
		return x.Epoch
	}
...
func (x *AggregateAttestationAndProofElectra) GetAggregatorIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.AggregatorIndex
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex(0)
...
type SingleAttestation struct {
	state         protoimpl.MessageState                                                     `protogen:"open.v1"`
	CommitteeId   github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.CommitteeIndex `protobuf:"varint,1,opt,name=committee_id,json=committeeId,proto3" json:"committee_id,omitempty" cast-type:"github.com/sila-chain/Sila-Consensus-Core/v7/consensus-types/primitives.CommitteeIndex"`
	AttesterIndex github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=attester_index,json=attesterIndex,proto3" json:"attester_index,omitempty" cast-type:"github.com/sila-chain/Sila-Consensus-Core/v7/consensus-types/primitives.ValidatorIndex"`
...
func (x *SingleAttestation) GetCommitteeId() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.CommitteeIndex {
	if x != nil {
...
func (x *SingleAttestation) GetAttesterIndex() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex {
	if x != nil {
