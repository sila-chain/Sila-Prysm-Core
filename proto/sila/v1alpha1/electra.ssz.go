...
func (a *AggregateAttestationAndProofElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	a.AggregatorIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[0:8])
...
func (s *SingleAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'CommitteeId'
	s.CommitteeId = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.CommitteeIndex](buf[0:8])

	// Field (1) 'AttesterIndex'
	s.AttesterIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[8:16])
...
func (b *BuilderBidElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Header == nil {
		b.Header = new(v1.SilaPayloadHeaderDeneb)
	}
...
func (b *BeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.SilaPayload == nil {
		b.SilaPayload = new(v1.SilaPayloadDeneb)
	}
...
func (b *BlindedBeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.SilaPayloadHeader == nil {
		b.SilaPayloadHeader = new(v1.SilaPayloadHeaderDeneb)
	}
...
func (b *BeaconStateElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[2736641:2736649])
	...
	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Gwei](buf[2736661:2736669])

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Gwei](buf[2736669:2736677])

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch](buf[2736677:2736685])

	// Field (32) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Gwei](buf[2736685:2736693])

	// Field (33) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch](buf[2736693:2736701])
...
func (p *PendingDeposit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'Slot'
	p.Slot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[184:192])
...
func (p *PendingPartialWithdrawal) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Index'
	p.Index = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[0:8])

	// Field (1) 'Amount'
	p.Amount = ssz.UnmarshallUint[uint64](buf[8:16])

	// Field (2) 'WithdrawableEpoch'
	p.WithdrawableEpoch = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch](buf[16:24])
...
func (p *PendingConsolidation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'SourceIndex'
	p.SourceIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[0:8])

	// Field (1) 'TargetIndex'
	p.TargetIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[8:16])
...
func (l *LightClientUpdateElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[25208:25216])
...
func (l *LightClientFinalityUpdateElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[392:400])
