...
func (l *LightClientUpdateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[25144:25152])
...
func (l *LightClientFinalityUpdateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[360:368])
...
func (l *LightClientOptimisticUpdateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot](buf[164:172])
...
func (l *LightClientHeaderCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if l.SilaLightClientPayloadHeader == nil {
		l.SilaLightClientPayloadHeader = new(v1.SilaPayloadHeaderCapella)
	}
...
func (b *BLSToSilaChange) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'ValidatorIndex'
	b.ValidatorIndex = ssz.UnmarshallUint[github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.ValidatorIndex](buf[0:8])
