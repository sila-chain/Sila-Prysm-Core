...
func (x *SignRequest) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
...
func (x *SignRequest) GetEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *SignRequest) GetSigningSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
...
type SignRequest_Slot struct {
	Slot github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot `protobuf:"varint,105,opt,name=slot,proto3,oneof" cast-type:"github.com/sila-chain/Sila-Consensus-Core/v7/consensus-types/primitives.Slot"`
}

type SignRequest_Epoch struct {
	Epoch github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch `protobuf:"varint,106,opt,name=epoch,proto3,oneof" cast-type:"github.com/sila-chain/Sila-Consensus-Core/v7/consensus-types/primitives.Epoch"`
}
...
func (x *BuilderConfig) GetGasLimit() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_validator.Uint64 {
	if x != nil {
		return x.GasLimit
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_validator.Uint64(0)
}
