...
func (x *InclusionSlotRequest) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *InclusionSlotResponse) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot(0)
...
func (x *BeaconStateRequest) GetSlot() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot {
	if x != nil {
...
type BeaconStateRequest_Slot struct {
	Slot github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=slot,proto3,oneof" cast-type:"github.com/sila-chain/Sila-Consensus-Core/v7/consensus-types/primitives.Slot"`
}
