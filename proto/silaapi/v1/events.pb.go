...
// 	protoc        v3.21.7
// source: proto/silaapi/v1/events.proto
...
func (x *EventChainReorg) GetEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
		return x.Epoch
	}
...
func (x *EventFinalizedCheckpoint) GetEpoch() github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch {
	if x != nil {
		return x.Epoch
	}
	return github_com_sila_chain_Sila_Sila_Core_v7_consensus_types_primitives.Epoch(0)
