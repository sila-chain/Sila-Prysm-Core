...
// 	protoc        v3.21.7
// source: proto/silaapi/ext/options.proto
...
var file_proto_silaapi_ext_options_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "proto/silaapi/ext/options.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*string)(nil),
...
var (
	...
	E_CastType = &file_proto_silaapi_ext_options_proto_extTypes[0]
	// optional string ssz_size = 50001;
	E_SszSize = &file_proto_silaapi_ext_options_proto_extTypes[1]
	// optional string ssz_max = 50002;
	E_SszMax = &file_proto_silaapi_ext_options_proto_extTypes[2]
	// optional string spec_name = 50003;
	E_SpecName = &file_proto_silaapi_ext_options_proto_extTypes[3]
)

var File_proto_silaapi_ext_options_proto protoreflect.FileDescriptor

var file_proto_silaapi_ext_options_proto_rawDesc = []byte{
...
var file_proto_silaapi_ext_options_proto_goTypes = []any{
	(*descriptorpb.FieldOptions)(nil), // 0: google.protobuf.FieldOptions
}
var file_proto_silaapi_ext_options_proto_depIdxs = []int32{
...
func init() { file_proto_silaapi_ext_options_proto_init() }
func file_proto_silaapi_ext_options_proto_init() {
	if File_proto_silaapi_ext_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_silaapi_ext_options_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 4,
			NumServices:   0,
		},
		GoTypes:           file_proto_silaapi_ext_options_proto_goTypes,
		DependencyIndexes: file_proto_silaapi_ext_options_proto_depIdxs,
		ExtensionInfos:    file_proto_silaapi_ext_options_proto_extTypes,
	}.Build()
	File_proto_silaapi_ext_options_proto = out.File
	file_proto_silaapi_ext_options_proto_rawDesc = nil
	file_proto_silaapi_ext_options_proto_goTypes = nil
	file_proto_silaapi_ext_options_proto_depIdxs = nil
}
