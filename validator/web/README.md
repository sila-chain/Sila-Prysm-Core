...
This is due to this PR removal of build content:https://github.com/medo202225/Sila-Prysm-Core

in order to update the `site_data.go` follow the following steps to update the specific release of https://github.com/medo202225/Sila-Prysm-Core
...
2. download the specific release from https://github.com/medo202225/Sila-Prysm-Core
