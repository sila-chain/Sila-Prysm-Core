...
func TestServer_InitializeRoutes(t *testing.T) {
	...
	wantRouteList := map[string][]string{
		"/sila/v1/keystores":                          {http.MethodGet, http.MethodPost, http.MethodDelete},
		"/sila/v1/remotekeys":                         {http.MethodGet, http.MethodPost, http.MethodDelete},
		"/sila/v1/validator/{pubkey}/gas_limit":       {http.MethodGet, http.MethodPost, http.MethodDelete},
		"/sila/v1/validator/{pubkey}/feerecipient":    {http.MethodGet, http.MethodPost, http.MethodDelete},
		"/sila/v1/validator/{pubkey}/voluntary_exit":  {http.MethodPost},
		"/sila/v1/validator/{pubkey}/graffiti":        {http.MethodGet, http.MethodPost, http.MethodDelete},
