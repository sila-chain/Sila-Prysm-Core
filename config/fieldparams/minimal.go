...
const (
	...
	SilaDataVotesLength                   = 32                // SLOTS_PER_SilaExecution_VOTING_PERIOD
	...
	ExecutionBranchDepth                  = 4                 // ExecutionBranchDepth defines the number of leaves in a merkle proof of the sila payload header.
