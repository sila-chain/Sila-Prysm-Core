...
var placeholderFields = []string{
	...
	"SIP6110_FORK_EPOCH",
	"SIP6110_FORK_VERSION",
	"SIP7002_FORK_EPOCH",
	"SIP7002_FORK_VERSION",
	"SIP7732_FORK_EPOCH",
	"SIP7732_FORK_VERSION",
	"SIP7928_FORK_EPOCH",
	"SIP7928_FORK_VERSION",
	"SIP8025_FORK_EPOCH",
	"SIP8025_FORK_VERSION",
...
func assertEqualConfigs(t *testing.T, name string, fields []string, expected, actual *params.BeaconChainConfig) {
	...
	// Validator params.
	assert.Equal(t, expected.SilaExecutionFollowDistance, actual.SilaExecutionFollowDistance, "%s: SilaExecutionFollowDistance", name)
	...
	assert.Equal(t, expected.EpochsPerSilaExecutionVotingPeriod, actual.EpochsPerSilaExecutionVotingPeriod, "%s: EpochsPerSilaExecutionVotingPeriod", name)
