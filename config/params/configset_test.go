...
func compareConfigs(t *testing.T, expected, actual *BeaconChainConfig) {
	...
	require.DeepEqual(t, expected.SilaDepositTreeDepth, actual.SilaDepositTreeDepth)
	...
	require.DeepEqual(t, expected.EpochsPerSilaExecutionVotingPeriod, actual.EpochsPerSilaExecutionVotingPeriod)
	...
	require.DeepEqual(t, expected.SilaDepositAddress, actual.SilaDepositAddress)
