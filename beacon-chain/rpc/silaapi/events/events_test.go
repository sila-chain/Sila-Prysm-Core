...
import (
	...
	"github.com/sila-chain/Sila-Consensus-Core/v7/beacon-chain/state/stategen/mock"
...
func (tr *topicRequest) testHttpRequest(ctx context.Context, _ *testing.T) *http.Request {
	...
	req := httptest.NewRequest(http.MethodGet, fmt.Sprintf("http://example.com/sila/v1/events?%s", strings.Join(tq, "&")), nil)
