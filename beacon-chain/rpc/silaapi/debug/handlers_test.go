...
func TestGetBeaconStateV2(t *testing.T) {
	...
	t.Run("phase0", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v2/debug/beacon/states/{state_id}", nil)
...
func TestGetForkChoiceHeadsV2(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v2/debug/beacon/heads", nil)
	writer := httptest.NewRecorder()
	writer.Body = &bytes.Buffer{}
...
func TestGetForkChoice(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/debug/fork_choice", nil)
	writer := httptest.NewRecorder()
	writer.Body = &bytes.Buffer{}
...
func TestGetForkChoiceV2(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v2/debug/fork_choice", nil)
	writer := httptest.NewRecorder()
	writer.Body = &bytes.Buffer{}
...
func TestDataColumnSidecars(t *testing.T) {
	t.Run("Fulu fork not configured", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/debug/beacon/data_column_sidecars/head", nil)
	...
	t.Run("Invalid indices", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/debug/beacon/data_column_sidecars/head?indices=9999", nil)
		request.SetPathValue("block_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("Gloas data columns", func(t *testing.T) {
		...
		gloasSidecar := &silapb.DataColumnSidecarGloas{
			Index:           3,
			Column:          [][]byte{cell},
...
func TestBuildDataColumnSidecarsSSZResponse(t *testing.T) {
	...
	t.Run("get SSZ size", func(t *testing.T) {
		size := (&silapb.DataColumnSidecar{}).SizeSSZ()
