...
func TestGetBlockV2(t *testing.T) {
	t.Run("Unsycned Block", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://foo.example/sila/v2/beacon/blocks/{block_id}", nil)
...
func TestGetBlockAttestationsV2(t *testing.T) {
	...
	t.Run("ok-pre-electra", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://foo.example/sila/v2/beacon/blocks/{block_id}/attestations", nil)
		request.SetPathValue("block_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
...
func TestGetBlindedBlock(t *testing.T) {
	t.Run("phase0", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://foo.example/sila/v1/beacon/blinded_blocks/{block_id}", nil)
		request.SetPathValue("block_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
...
func TestServer_GetBlockRoot(t *testing.T) {
	...
	url := "http://example.com/sila/v1/beacon/blocks/{block_id}/root"
...
func TestGetCommittees(t *testing.T) {
	db := dbTest.SetupDB(t)
	ctx := t.Context()
	url := "http://example.com/sila/v1/beacon/states/{state_id}/committees"
...
func TestServer_GetBlockHeader(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/headers/{block_id}", nil)
		request.SetPathValue("block_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
...
func TestGetFinalityCheckpoints(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		request := httptest.NewRequest(http.MethodGet, "/sila/v1/beacon/states/{state_id}/finality_checkpoints", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
...
func TestGetGenesis(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "/sila/v1/beacon/genesis", nil)
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
...
func TestGetPendingConsolidations(t *testing.T) {
	...
	t.Run("json response", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/pending_consolidations", nil)
	...
	t.Run("pre electra state", func(t *testing.T) {
		...
		// Test SSZ request
		sszReq := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/pending_consolidations", nil)
...
func TestGetPendingDeposits(t *testing.T) {
	...
	t.Run("json response", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/pending_deposits", nil)
		req.SetPathValue("state_id", "head")
		rec := httptest.NewRecorder()
		rec.Body = new(bytes.Buffer)
	...
	t.Run("pre electra state", func(t *testing.T) {
		...
		// Test SSZ request
		sszReq := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/pending_deposits", nil)
		sszReq.Header.Set("Accept", "application/octet-stream")
		sszReq.SetPathValue("state_id", "head")
		sszRec := httptest.NewRecorder()
		sszRec.Body = new(bytes.Buffer)
...
func TestGetPendingPartialWithdrawals(t *testing.T) {
	...
	t.Run("json response", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/pending_partial_withdrawals", nil)
		req.SetPathValue("state_id", "head")
		rec := httptest.NewRecorder()
		rec.Body = new(bytes.Buffer)
	...
	t.Run("pre electra state", func(t *testing.T) {
		...
		// Test SSZ request
		sszReq := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/pending_partial_withdrawals", nil)
		sszReq.Header.Set("Accept", "application/octet-stream")
		sszReq.SetPathValue("state_id", "head")
		sszRec := httptest.NewRecorder()
		sszRec.Body = new(bytes.Buffer)
...
func TestGetProposerLookahead(t *testing.T) {
	...
	t.Run("json response", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/proposer_lookahead", nil)
		req.SetPathValue("state_id", "head")
		rec := httptest.NewRecorder()
		rec.Body = new(bytes.Buffer)
	...
	t.Run("pre fulu state", func(t *testing.T) {
		...
		// Test SSZ request
		sszReq := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/proposer_lookahead", nil)
		sszReq.Header.Set("Accept", "application/octet-stream")
		sszReq.SetPathValue("state_id", "head")
		sszRec := httptest.NewRecorder()
		sszRec.Body = new(bytes.Buffer)
