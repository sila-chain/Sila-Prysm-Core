...
func TestGetValidators(t *testing.T) {
	...
	t.Run("get all", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validators", nil)
	...
	t.Run("get by index", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			"http://example.com/sila/v1/beacon/states/{state_id}/validators?id=0&id=1",
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("get by pubkey", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			fmt.Sprintf("http://example.com/sila/v1/beacon/states/{state_id}/validators?id=%s&id=%s", hexPubkey1, hexPubkey2),
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("get by both index and pubkey", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			fmt.Sprintf("http://example.com/sila/v1/beacon/states/{state_id}/validators?id=%s&id=1", hexPubkey),
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("unknown pubkey is ignored", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			fmt.Sprintf("http://example.com/sila/v1/beacon/states/{state_id}/validators?id=%s&id=%s", hexPubkey, hexutil.Encode([]byte(strings.Repeat("x", fieldparams.BLSPubkeyLength)))),
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("unknown index is ignored", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validators?id=1&id=99999", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("POST", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodPost,
			"http://example.com/sila/v1/beacon/states/{state_id}/validators",
			&body,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
...
func TestGetValidators_FilterByStatus(t *testing.T) {
	...
	t.Run("active", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validators?status=active", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("active_ongoing", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validators?status=active_ongoing", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("exited", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validators?status=exited", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("pending_initialized and exited_unslashed", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			"http://example.com/sila/v1/beacon/states/{state_id}/validators?status=pending_initialized&status=exited_unslashed",
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("pending and exited_slashed", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			"http://example.com/sila/v1/beacon/states/{state_id}/validators?status=pending&status=exited_slashed",
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
...
func TestGetValidator(t *testing.T) {
	...
	t.Run("get by index", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validators/{validator_id}", nil)
		request.SetPathValue("state_id", "head")
...
func TestGetValidatorBalances(t *testing.T) {
	...
	t.Run("get all", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validator_balances", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("get by index", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			"http://example.com/sila/v1/beacon/states/{state_id}/validator_balances?id=0&id=1",
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("get by pubkey", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			fmt.Sprintf("http://example.com/sila/v1/beacon/states/{state_id}/validator_balances?id=%s&id=%s", hexPubkey1, hexPubkey2),
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("get by both index and pubkey", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			fmt.Sprintf("http://example.com/sila/v1/beacon/states/{state_id}/validator_balances?id=%s&id=1", hexPubkey),
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("unknown pubkey is ignored", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			fmt.Sprintf("http://example.com/sila/v1/beacon/states/{state_id}/validator_balances?id=%s&id=%s", hexPubkey, hexutil.Encode([]byte(strings.Repeat("x", fieldparams.BLSPubkeyLength)))),
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("unknown index is ignored", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/beacon/states/{state_id}/validator_balances?id=1&id=99999", nil)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	t.Run("execution optimistic", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodGet,
			"http://example.com/sila/v1/beacon/states/{state_id}/validator_balances?id=0",
			nil,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
	...
	t.Run("POST", func(t *testing.T) {
		...
		request := httptest.NewRequest(
			http.MethodPost,
			"http://example.com/sila/v1/beacon/states/{state_id}/validator_balances",
			&body,
		)
		request.SetPathValue("state_id", "head")
		writer := httptest.NewRecorder()
...
func TestGetValidatorIdentities(t *testing.T) {
	...
	t.Run("json", func(t *testing.T) {
		t.Run("get all", func(t *testing.T) {
			...
			_, err := body.WriteString("[]")
			require.NoError(t, err)
			request := httptest.NewRequest(http.MethodPost, "http://example.com/sila/v1/beacon/states/{state_id}/validator_identities", &body)
			request.SetPathValue("state_id", "head")
			writer := httptest.NewRecorder()
			writer.Body = &bytes.Buffer{}
	...
	t.Run("errors", func(t *testing.T) {
		...
		t.Run("empty body returns all", func(t *testing.T) {
			...
			request := httptest.NewRequest(http.MethodPost, "http://example.com/sila/v1/beacon/states/{state_id}/validator_identities", nil)
			request.SetPathValue("state_id", "head")
			writer := httptest.NewRecorder()
			writer.Body = &bytes.Buffer{}
