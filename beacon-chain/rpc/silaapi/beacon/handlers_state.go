...
func (s *Server) GetSyncCommittees(w http.ResponseWriter, r *http.Request) {
	...
	var committee *silapbalpha.SyncCommittee
...
func committeeIndicesFromState(st state.BeaconState, committee *silapbalpha.SyncCommittee) ([]string, *silapbalpha.SyncCommittee, error) {
...
func currentCommitteeIndicesFromState(st state.BeaconState) ([]string, *silapbalpha.SyncCommittee, error) {
...
func nextCommitteeIndicesFromState(st state.BeaconState) ([]string, *silapbalpha.SyncCommittee, error) {
...
func extractSyncSubcommittees(st state.BeaconState, committee *silapbalpha.SyncCommittee) ([][]string, error) {
