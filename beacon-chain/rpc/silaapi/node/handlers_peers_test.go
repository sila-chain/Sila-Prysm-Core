...
func TestGetPeer(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/node/peers/{peer_id}", nil)
...
func TestGetPeers(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/node/peers?state=connecting&direction=inbound", nil)
		writer := httptest.NewRecorder()
		writer.Body = &bytes.Buffer{}
	...
	for _, tt := range filterTests {
		t.Run(tt.name, func(t *testing.T) {
			...
			request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/node/peers?"+statesQuery+"&"+directionsQuery, nil)
			writer := httptest.NewRecorder()
			writer.Body = &bytes.Buffer{}
...
func TestGetPeers_NoPeersReturnsEmptyArray(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/node/peers?state=connecting&state=connected", nil)
	writer := httptest.NewRecorder()
	writer.Body = &bytes.Buffer{}
...
func TestGetPeerCount(t *testing.T) {
	...
	s := Server{PeersFetcher: peerFetcher}
	request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/node/peer_count", nil)
	writer := httptest.NewRecorder()
	writer.Body = &bytes.Buffer{}
...
func BenchmarkGetPeers(b *testing.B) {
	...
	s := Server{PeersFetcher: peerFetcher}
	request := httptest.NewRequest(http.MethodGet, "http://example.com/sila/v1/node/peers", nil)
	writer := httptest.NewRecorder()
	writer.Body = &bytes.Buffer{}
	s.GetPeers(writer, request)
