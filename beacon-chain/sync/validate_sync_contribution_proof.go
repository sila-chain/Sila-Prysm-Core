...
func (s *Service) readSyncContributionMessage(msg *pubsub.Message) (*silapb.SignedContributionAndProof, error) {
	raw, err := s.decodePubsubMessage(msg)
	if err != nil {
		return nil, err
	}
	m, ok := raw.(*silapb.SignedContributionAndProof)
	if !ok {
...
func rejectIncorrectSubcommitteeIndex(
	m *silapb.SignedContributionAndProof,
) validationFn {
...
func rejectEmptyContribution(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func (s *Service) ignoreSeenSyncContribution(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func rejectInvalidAggregator(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func (s *Service) rejectInvalidIndexInSubCommittee(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func (s *Service) rejectInvalidSelectionProof(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func (s *Service) rejectInvalidContributionSignature(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func (s *Service) rejectInvalidSyncAggregateSignature(m *silapb.SignedContributionAndProof) validationFn {
	return func(ctx context.Context) (pubsub.ValidationResult, error) {
...
func (s *Service) setSyncContributionBits(c *silapb.SyncCommitteeContribution) error {
...
func (s *Service) hasSeenSyncContributionBits(c *silapb.SyncCommitteeContribution) (bool, error) {
...
func bitListOverlaps(bitLists [][]byte, b []byte) (bool, error) {
	for _, bitList := range bitLists {
		...
		bl := silapb.ConvertToSyncContributionBitVector(bitList)
		overlaps, err := bl.Overlaps(silapb.ConvertToSyncContributionBitVector(b))
		if err != nil {
			return false, err
		}
		if overlaps {
...
// selection proof.
func (s *Service) verifySyncSelectionData(ctx context.Context, m *silapb.ContributionAndProof) error {
	selectionData := &silapb.SyncAggregatorSelectionData{Slot: m.Contribution.Slot, SubcommitteeIndex: m.Contribution.SubcommitteeIndex}
