// Package depositsnapshot implements the SIP-4881 standard for minimal sparse Merkle tree.
...
// Full SIP-4881 specification can be found here: https://sips.sila.org/SIPS/sip-4881
