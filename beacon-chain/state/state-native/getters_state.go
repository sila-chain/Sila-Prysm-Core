...
func (b *BeaconState) ToProtoUnsafe() any {
	...
	case version.Phase0:
		return &silapb.BeaconState{
			...
			SilaexecDepositIndex:            b.silaExecutionDepositIndex,
			Validators:                  vals,
			Balances:                    bals,
			RandaoMixes:                 rm,
	...
	case version.Capella:
		return &silapb.BeaconStateCapella{
			...
			CurrentSyncCommittee:         b.currentSyncCommittee,
			NextSyncCommittee:            b.nextSyncCommittee,
			LatestSilaPayloadHeader: b.latestSilaPayloadHeaderCapella,
	...
	case version.Deneb:
		return &silapb.BeaconStateDeneb{
			...
			CurrentSyncCommittee:         b.currentSyncCommittee,
			NextSyncCommittee:            b.nextSyncCommittee,
			LatestSilaPayloadHeader: b.latestSilaPayloadHeaderDeneb,
			NextWithdrawalIndex:          b.nextWithdrawalIndex,
			NextWithdrawalValidatorIndex: b.nextWithdrawalValidatorIndex,
			HistoricalSummaries:          b.historicalSummaries,
		}
...
func (b *BeaconState) ToProto() any {
	...
	case version.Phase0:
		return &silapb.BeaconState{
			...
			StateRoots:                  sr,
			HistoricalRoots:             b.historicalRoots.Slice(),
			SilaData:                    b.silaexecDataVal(),
			SilaDataVotes:               b.silaDataVotesVal(),
			SilaexecDepositIndex:            b.silaExecutionDepositIndex,
	...
	case version.Capella:
		return &silapb.BeaconStateCapella{
			...
			CurrentSyncCommittee:         b.currentSyncCommitteeVal(),
			NextSyncCommittee:            b.nextSyncCommitteeVal(),
			LatestSilaPayloadHeader: b.latestSilaPayloadHeaderCapella.Copy(),
			NextWithdrawalIndex:          b.nextWithdrawalIndex,
			NextWithdrawalValidatorIndex: b.nextWithdrawalValidatorIndex,
	...
	case version.Deneb:
		return &silapb.BeaconStateDeneb{
			...
			CurrentSyncCommittee:         b.currentSyncCommitteeVal(),
			NextSyncCommittee:            b.nextSyncCommitteeVal(),
			LatestSilaPayloadHeader: b.latestSilaPayloadHeaderDeneb.Copy(),
			NextWithdrawalIndex:          b.nextWithdrawalIndex,
			NextWithdrawalValidatorIndex: b.nextWithdrawalValidatorIndex,
			HistoricalSummaries:          b.historicalSummariesVal(),
		}
