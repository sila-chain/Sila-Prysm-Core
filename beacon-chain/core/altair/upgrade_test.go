...
func TestUpgradeToAltair(t *testing.T) {
	...
	require.DeepSSZEqual(t, preForkState.SilaData(), aState.SilaData())
	require.DeepSSZEqual(t, preForkState.SilaDataVotes(), aState.SilaDataVotes())
	require.DeepSSZEqual(t, preForkState.SilaExecutionDepositIndex(), aState.SilaExecutionDepositIndex())
