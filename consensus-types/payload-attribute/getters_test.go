...
func TestPayloadAttributeGetters(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			tc: func(t *testing.T) {
				r := []byte{1, 2, 3}
				a, err := New(&silaenginev1.PayloadAttributes{PrevRandao: r})
		...
		},
		{
			...
			tc: func(t *testing.T) {
				r := []byte{4, 5, 6}
				a, err := New(&silaenginev1.PayloadAttributes{SuggestedFeeRecipient: r})
				require.NoError(t, err)
		...
		},
		{
			...
			tc: func(t *testing.T) {
				r := uint64(123)
				a, err := New(&silaenginev1.PayloadAttributes{Timestamp: r})
				require.NoError(t, err)
		...
		},
		{
			...
			tc: func(t *testing.T) {
				wd := []*silaenginev1.Withdrawal{{Index: 1}, {Index: 2}, {Index: 3}}
				a, err := New(&silaenginev1.PayloadAttributesV2{Withdrawals: wd})
				require.NoError(t, err)
		...
		},
		{
			...
			tc: func(t *testing.T) {
				wd := []*silaenginev1.Withdrawal{{Index: 1}, {Index: 2}, {Index: 3}}
				a, err := New(&silaenginev1.PayloadAttributesV3{Withdrawals: wd})
				require.NoError(t, err)
				got, err := a.Withdrawals()
				require.NoError(t, err)
				require.DeepEqual(t, wd, got)
		...
		},
		{
			...
			tc: func(t *testing.T) {
				a, err := New(&silaenginev1.PayloadAttributes{})
				require.NoError(t, err)
				_, err = a.PbV2()
		...
		},
		{
			...
			tc: func(t *testing.T) {
				a, err := New(&silaenginev1.PayloadAttributesV2{})
				require.NoError(t, err)
				_, err = a.PbV1()
		...
		},
		{
			...
			tc: func(t *testing.T) {
				...
				got, err := a.PbV1()
				require.NoError(t, err)
				require.Equal(t, (*silaenginev1.PayloadAttributes)(nil), got)
			},
		},
		{
			...
			tc: func(t *testing.T) {
				...
				got, err := a.PbV2()
				require.NoError(t, err)
				require.Equal(t, (*silaenginev1.PayloadAttributesV2)(nil), got)
			},
		},
		{
			name: "Get PbBellatrix",
			tc: func(t *testing.T) {
				p := &silaenginev1.PayloadAttributes{
					Timestamp:             1,
		...
		},
		{
			name: "Get PbCapella",
			tc: func(t *testing.T) {
				p := &silaenginev1.PayloadAttributesV2{
					Timestamp:             1,
					PrevRandao:            []byte{1, 2, 3},
					SuggestedFeeRecipient: []byte{4, 5, 6},
					Withdrawals:           []*silaenginev1.Withdrawal{{Index: 1}, {Index: 2}, {Index: 3}},
				}
				a, err := New(p)
				require.NoError(t, err)
				got, err := a.PbV2()
		...
		},
		{
			name: "Get PbDeneb",
			tc: func(t *testing.T) {
				p := &silaenginev1.PayloadAttributesV3{
					Timestamp:             1,
					PrevRandao:            []byte{1, 2, 3},
					SuggestedFeeRecipient: []byte{4, 5, 6},
					Withdrawals:           []*silaenginev1.Withdrawal{{Index: 1}, {Index: 2}, {Index: 3}},
		...
		},
		{
			...
			tc: func(t *testing.T) {
				a, err := New(&silaenginev1.PayloadAttributesV3{})
				require.NoError(t, err)
				got, err := a.PbV3()
				require.NoError(t, err)
				require.Equal(t, (*silaenginev1.PayloadAttributesV3)(nil), got)
			},
		},
		{
	...
	tests := []struct {
		...
		},
		{
			...
			a: &data{
				...
				withdrawals: make([]*silaenginev1.Withdrawal, 1),
			},
			empty: false,
		},
		{
